        ...
        return (
            <>
                ...
                <div className="bg-white h-100v w-100v pl-52 pr-8">
                    ...
                    <button class="bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 px-2 rounded-full focus:ring-0" >Volver a buscar</button>
                    </li>
                    ...
                    <button class="bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 px-2 rounded-full focus:ring-0" >Ver mis reservas</button>
