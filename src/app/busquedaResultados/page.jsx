        ...
        return (
            <>
                ...
                <div className="bg-white h-100v w-100v pl-52 pr-8">
                    ...
                    <button className="bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 px-2 rounded-full focus:ring-0" >Volver a buscar</button>
                    </li>
                    <hr className="my-8 h-0.5 border-t-0 bg-[#CAC4D0] opacity-100" />
                    <div className="flex" >
                    <p className="pt-1 text-1xl text-left">Resultados de la busqueda</p>
                    <button className="bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 px-2 rounded-full focus:ring-0" >Ver mis reservas</button>
